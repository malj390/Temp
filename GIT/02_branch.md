...
- [Branch Management](#branch-management)
	...
	- [Part 1: Creating Branches](#part-1-creating-branches)
		- [`git checkout -b <name> <start-point>` - Branch from Specific Commit](#git-checkout--b-name-start-point---branch-from-specific-commit)
	- [Part 2: Switching Between Branches](#part-2-switching-between-branches)
		- [`git checkout <branch>` - Switch Branch](#git-checkout-branch---switch-branch)
		- [`git switch <branch>` - Modern Switch](#git-switch-branch---modern-switch)
		- [Switching with Uncommitted Changes](#switching-with-uncommitted-changes)
			- [Option 1: Commit the changes](#option-1-commit-the-changes)
			- [Option 2: Stash the changes (recommended for temporary switch)](#option-2-stash-the-changes-recommended-for-temporary-switch)
			- [Option 3: Carry changes (if no conflicts)](#option-3-carry-changes-if-no-conflicts)
	- [Part 3: Viewing Branches](#part-3-viewing-branches)
		- [`git branch` - List Local Branches](#git-branch---list-local-branches)
		- [`git branch -a` - List All Branches (Local + Remote)](#git-branch--a---list-all-branches-local--remote)
		- [`git branch -r` - List Remote Branches Only](#git-branch--r---list-remote-branches-only)
		- [`git branch -v` - List with Last Commit](#git-branch--v---list-with-last-commit)
		- [`git branch -vv` - Show Tracking Information](#git-branch--vv---show-tracking-information)
	- [Part 4: Deleting Branches](#part-4-deleting-branches)
		- [`git branch -d <branch>` - Safe Delete (Merged Only)](#git-branch--d-branch---safe-delete-merged-only)
		- [`git branch -D <branch>` - Force Delete](#git-branch--d-branch---force-delete)
		- [Deleting Remote Branches](#deleting-remote-branches)
			- [`git push origin --delete <branch>` - Delete Remote Branch](#git-push-origin---delete-branch---delete-remote-branch)
		- [Pruning Stale Remote References](#pruning-stale-remote-references)
	- [Part 5: Renaming Branches](#part-5-renaming-branches)
		- [`git branch -m <new-name>` - Rename Current Branch](#git-branch--m-new-name---rename-current-branch)
		- [`git branch -m <old> <new>` - Rename Any Branch](#git-branch--m-old-new---rename-any-branch)
		- [Renaming and Updating Remote](#renaming-and-updating-remote)
	- [Part 6: Local vs Remote Branches](#part-6-local-vs-remote-branches)
		...
		- [Setting Up Tracking](#setting-up-tracking)
			- [Automatic (when pushing with -u)](#automatic-when-pushing-with--u)
			- [Manual tracking setup](#manual-tracking-setup)
		- [Checking Tracking Status](#checking-tracking-status)
		- [Fetching Remote Branches](#fetching-remote-branches)
		- [Comparing Local and Remote](#comparing-local-and-remote)
	- [Part 7: Branch Naming Conventions](#part-7-branch-naming-conventions)
		- [Common Patterns](#common-patterns)
			- [By Type](#by-type)
			- [By Developer](#by-developer)
			- [By Issue/Ticket](#by-issueticket)
	...
	- [Practice Exercises](#practice-exercises)
		- [Exercise 1: Complete Branch Lifecycle](#exercise-1-complete-branch-lifecycle)
		- [Exercise 2: Working with Remote Branches](#exercise-2-working-with-remote-branches)
		- [Exercise 3: Branch Comparison](#exercise-3-branch-comparison)
	- [Common Scenarios](#common-scenarios)
		- [Scenario 1: "I'm on the wrong branch!"](#scenario-1-im-on-the-wrong-branch)
		- [Scenario 2: "I want to switch branches but have uncommitted work"](#scenario-2-i-want-to-switch-branches-but-have-uncommitted-work)
		- [Scenario 3: "Remote branch was deleted but I still see it"](#scenario-3-remote-branch-was-deleted-but-i-still-see-it)
	- [Quick Reference](#quick-reference)
		- [`git checkout -b <name>` - Create and Switch](#git-checkout--b-name---create-and-switch)
		- [`git switch -c <name>` - Modern Create and Switch](#git-switch--c-name---modern-create-and-switch)
